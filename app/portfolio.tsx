...
export default function Portfolio() {
  ...
  const sendEmail = () => {
    window.location.href = 'mailto:andrewmintah@gmail.com';
  };
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:andrewmintah@gmail.com?subject=${subject}&body=${body}`;
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <nav className="fixed top-0 w-full bg-slate-900/80 backdrop-blur-md z-50 border-b border-blue-500/20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-400">
              A.M
            </div>
          ...
          <div className="md:hidden bg-slate-800 border-t border-blue-500/20">
            {navItems.map((item) => (
              <button
                key={item}
                onClick={() => scrollToSection(item)}
                className="block w-full text-left px-4 py-3 text-gray-300 hover:bg-slate-700 hover:text-blue-400 transition-colors"
              >
                {item}
              </button>
            ))}
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-5xl sm:text-5xl font-bold text-white mb-6 animate-fade-in">
            Hi, I'm <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-400">Andrew Mintah</span>
          </h1>
          <p className="text-xl sm:text-2xl text-gray-300 mb-8">
            Senior Engineer | Creative Problem Solver
          </p>
          <div className="flex justify-center gap-4">
            <a href="https://github.com/andymintah" className="p-3 bg-blue-600 hover:bg-blue-700 rounded-full transition-colors">
              <Github className="text-white" size={24} />
            </a>
            <a href="https://www.linkedin.com/in/andrew-mintah/" className="p-3 bg-blue-600 hover:bg-blue-700 rounded-full transition-colors">
              <Linkedin className="text-white" size={24} />
            </a>
            <button onClick={sendEmail} className="p-3 bg-blue-600 hover:bg-blue-700 rounded-full transition-colors">
      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-800/50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-900/50 rounded-lg p-8 border border-blue-500/20">
...
delivering high-quality engineering outcomes in regulated environments.
            ...
            {[
              {
                ...
                description: 'A full-featured banking backend application with account management, fund transfers, and transaction history.',
                tech: ['Java', 'Spring Boot', 'MySql'],
                link: 'https://github.com/andymintah/persbank'
              },
              {
                title: 'Binance Streaming App',
                description: 'Real-time cryptocurrency price tracking app with live updates and historical data visualization.',
                tech: ['Python','Redpanda'],
                link: 'https://github.com/andymintah/binance-streaming'

              },
              {
                title: 'ETL Data Pipeline',
                description: 'An ETL pipeline that extracts data from a data store, transforms it, and loads it into a data warehouse for analysis.',
                tech: ['Python'],
                link: 'https://github.com/andymintah/etlapp'
              }
            ].map((project, index) => (
              <div key={index} className="bg-slate-900/50 rounded-lg p-6 border border-blue-500/20 hover:border-blue-500/40 transition-all hover:transform hover:scale-105">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-slate-800 border border-blue-500/20 rounded-lg text-white focus:outline-none focus:border-blue-500"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-600 to-blue-600 hover:from-blue-700 hover:to-blue-700 text-white font-semibold py-3 rounded-lg transition-all"
              >
                Send Message
              </button>
            </form>
      ...
      {/* Footer */}
      <footer className="py-8 px-4 text-center border-t border-blue-500/20">
